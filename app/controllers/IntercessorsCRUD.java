...
@CRUD.For(models.Intercessor.class)
@With(Secure.class)
public class IntercessorsCRUD extends CRUD {
	...
	public static void show(String id) throws Exception {
		...
		Intercessor object = Intercessor.find("id = " + id + " and institutionId = " + Admin.getLoggedUserInstitution().getInstitution().getId()).first();
